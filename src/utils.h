...
const LOG_LEVELS PCA9685_LOG_LEVEL = MAX;//set_level(LOG_LEVELS::DISABLED);
...
const LOG_LEVELS UI_BLOCK_LOG_LEVEL = MAX;//set_level(LOG_LEVELS::LOG0);
const LOG_LEVELS MAIN_LOG_LEVEL = MAX;//MAX | set_level(LOG_LEVELS::LOG0);
