...
OBJECTS += USBDevice/targets/TARGET_STM/USBHAL_STM32.o
OBJECTS += USBDevice/targets/TARGET_STM/USBHAL_STM32F4.o
OBJECTS += main.o
...
INCLUDE_PATHS += -I../USBDevice/targets/TARGET_STM
INCLUDE_PATHS += -I../USBDevice/targets/TARGET_STM/TARGET_STM32F4
INCLUDE_PATHS += -I../USBDevice/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F411xE
INCLUDE_PATHS += -I../USBDevice/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F411xE/TARGET_NUCLEO_F411RE
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1509999611.45
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1509999611.45
...
ASM_FLAGS += -IUSBDevice/targets/TARGET_STM
ASM_FLAGS += -IUSBDevice/targets/TARGET_STM/TARGET_STM32F4
ASM_FLAGS += -IUSBDevice/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F411xE
ASM_FLAGS += -IUSBDevice/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F411xE/TARGET_NUCLEO_F411RE
ASM_FLAGS += -Imbed/.
